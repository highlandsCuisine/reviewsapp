var customErrorMessages = {
  ...
  'auth/missing-email': 'Email field might be empty, invalid or not verified.',
...
exports.handleFirebaseError = async (error) => {
  var customMessage = customErrorMessages[error];
  if (customMessage) {
